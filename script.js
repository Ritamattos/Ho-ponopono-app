...
},
{
            ...
            pages: [
    {
        ...
        <div style="background: rgba(139, 92, 246, 0.2); padding: 20px; border-radius: 15px; text-align: center; margin: 20px 0;">
            <p style="font-size: 1.2em; color: #10b981;">"Quando você assume 100% de responsabilidade,</p>
            <p style="font-size: 1.2em; color: #10b981;">você ganha 100% do poder"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em; text-align: center; color: #c4b5fd; font-style: italic;">Prepare-se para descobrir o verdadeiro poder da responsabilidade total! 🌺</p>`
    },
    {
        title: "🔬 A Base Científica",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🧬 Ho'oponopono e a Ciência</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Pesquisas modernas confirmam o que os antigos havaianos já sabiam: nossa mente tem poder direto sobre a realidade.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 10px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #10b981;">🔬 Evidências:</strong></p>
            <p style="margin: 5px 0;">• Neuroplasticidade cerebral</p>
            <p style="margin: 5px 0;">• Influência quântica do observador</p>
            <p style="margin: 5px 0;">• Epigenética emocional</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">O Ho'oponopono trabalha com estes princípios científicos naturalmente.</p>`
    },
    {
        title: "⚖️ Responsabilidade vs Culpa",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🎭 A Grande Diferença</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Responsabilidade Total não significa que você causou tudo. Significa que você pode limpar tudo.</p>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin: 20px 0;">
            <div style="background: rgba(239, 68, 68, 0.2); padding: 15px; border-radius: 10px;">
                <h4 style="color: #ef4444; margin-bottom: 8px;">❌ Culpa</h4>
                <p style="font-size: 0.9em;">• Paralisa</p>
                <p style="font-size: 0.9em;">• Vitimiza</p>
                <p style="font-size: 0.9em;">• Aponta dedos</p>
            </div>
            <div style="background: rgba(16, 185, 129, 0.2); padding: 15px; border-radius: 10px;">
                <h4 style="color: #10b981; margin-bottom: 8px;">✅ Responsabilidade</h4>
                <p style="font-size: 0.9em;">• Empodera</p>
                <p style="font-size: 0.9em;">• Transforma</p>
                <p style="font-size: 0.9em;">• Assume o poder</p>
            </div>
        </div>`
    },
    {
        title: "🧠 Como Funciona a Mente",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🗺️ O Mapa Mental</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Entenda como pensamentos e memórias criam sua realidade.</p>
        <div style="background: rgba(139, 92, 246, 0.1); padding: 20px; border-radius: 15px; margin: 20px 0; text-align: center;">
            <p style="color: #8b5cf6; margin: 8px 0;">🎭 Memórias Inconscientes</p>
            <p style="color: #c4b5fd;">↓</p>
            <p style="color: #f59e0b; margin: 8px 0;">💭 Pensamentos Automáticos</p>
            <p style="color: #c4b5fd;">↓</p>
            <p style="color: #ef4444; margin: 8px 0;">😰 Emoções Reativas</p>
            <p style="color: #c4b5fd;">↓</p>
            <p style="color: #10b981; margin: 8px 0;">🌍 Realidade Externa</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">Ho'oponopono limpa na origem!</p>`
    },
    {
        title: "🌊 O Oceano de Memórias",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌊 Mergulhando no Inconsciente</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Carregamos milhões de memórias que influenciam nossa vida sem percebermos.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #10b981;">🧬 Tipos de Memórias:</strong></p>
            <p style="margin: 5px 0;">• Ancestrais (dos antepassados)</p>
            <p style="margin: 5px 0;">• Familiares (da infância)</p>
            <p style="margin: 5px 0;">• Pessoais (desta vida)</p>
            <p style="margin: 5px 0;">• Coletivas (da humanidade)</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">A boa notícia: você pode limpar todas!</p>`
    },
    {
        title: "🔍 Identificando Memórias Ativas",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🚨 Sinais de Alerta</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Certas situações "disparam" memórias antigas. Aprenda a reconhecê-las.</p>
        <div style="background: rgba(239, 68, 68, 0.2); padding: 20px; border-radius: 10px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #ef4444;">🚨 Memórias Ativas:</strong></p>
            <p style="margin: 5px 0;">• Reações emocionais intensas</p>
            <p style="margin: 5px 0;">• Pensamentos obsessivos</p>
            <p style="margin: 5px 0;">• Padrões que se repetem</p>
            <p style="margin: 5px 0;">• Pessoas que sempre irritam</p>
        </div>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 15px; border-radius: 10px; text-align: center;">
            <p style="color: #10b981;"><strong>"Se te incomoda, é memória para limpar"</strong></p>
        </div>`
    },
    {
        title: "🔄 O Ciclo das Memórias",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌀 Quebrando Padrões</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Memórias não limpas criam ciclos que se repetem até serem liberadas.</p>
        <div style="background: rgba(139, 92, 246, 0.1); padding: 20px; border-radius: 15px; margin: 20px 0; text-align: center;">
            <p style="color: #ef4444; margin: 5px 0;">Situação Trigger</p>
            <p style="color: #c4b5fd;">↓</p>
            <p style="color: #f59e0b; margin: 5px 0;">Memória Ativada</p>
            <p style="color: #c4b5fd;">↓</p>
            <p style="color: #8b5cf6; margin: 5px 0;">Reação Emocional</p>
            <p style="color: #c4b5fd;">↓</p>
            <p style="color: #10b981; margin: 5px 0;">Resultado que Confirma</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em; text-align: center; color: #10b981; font-style: italic;">Ho'oponopono quebra este ciclo!</p>`
    },
    {
        title: "⚡ Tipos de Limpeza",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">✨ Instantânea vs Gradual</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Algumas memórias se dissolvem rapidamente, outras precisam de mais tempo. Ambos são perfeitos.</p>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin: 20px 0;">
            <div style="background: rgba(16, 185, 129, 0.2); padding: 15px; border-radius: 10px;">
                <h4 style="color: #10b981; margin-bottom: 8px;">⚡ Instantânea</h4>
                <p style="font-size: 0.9em;">• Alívio imediato</p>
                <p style="font-size: 0.9em;">• Mudança súbita</p>
                <p style="font-size: 0.9em;">• Leveza total</p>
            </div>
            <div style="background: rgba(139, 92, 246, 0.2); padding: 15px; border-radius: 10px;">
                <h4 style="color: #8b5cf6; margin-bottom: 8px;">🌱 Gradual</h4>
                <p style="font-size: 0.9em;">• Por camadas</p>
                <p style="font-size: 0.9em;">• Melhora progressiva</p>
                <p style="font-size: 0.9em;">• Cura profunda</p>
            </div>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">Confie no timing divino!</p>`
    },
    {
        title: "💎 A Regra de Ouro",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌟 O Princípio Fundamental</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Existe uma regra simples que transforma sua vida quando aplicada consistentemente.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 25px; border-radius: 15px; text-align: center; margin: 25px 0;">
            <p style="font-size: 1.3em; color: #10b981; margin-bottom: 15px;"><strong>💎 REGRA DE OURO</strong></p>
            <p style="font-size: 1.2em; color: #e9d5ff;">"Tudo que aparece na sua vida</p>
            <p style="font-size: 1.2em; color: #e9d5ff;">é uma oportunidade de limpeza"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">Problemas = Presentes disfarçados</p>
        <p style="line-height: 1.8; font-size: 1.1em;">Conflitos = Espelhos para cura</p>`
    },
    {
        title: "🎨 Personalizando as Frases",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🎭 Adaptando para Situações</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Você pode adaptar as 4 frases mantendo a essência para situações específicas.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #10b981;">💰 Para Dinheiro:</strong></p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Sinto muito pelas memórias de escassez"</p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Me perdoe por limitar abundância"</p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Te amo, prosperidade infinita"</p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Sou grato pela abundância"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">Nas próximas páginas, veremos mais exemplos!</p>`
    },
    {
        title: "🚶‍♀️ Ho'oponopono em Movimento",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌀 Praticando em Ação</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Ho'oponopono não é apenas sentado. Pode ser feito caminhando, trabalhando, vivendo!</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 10px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #10b981;">🌟 Práticas Dinâmicas:</strong></p>
            <p style="margin: 5px 0;">• Caminhando: frases com os passos</p>
            <p style="margin: 5px 0;">• Respirando: uma frase por respiração</p>
            <p style="margin: 5px 0;">• Trabalhando: mentalmente durante tarefas</p>
            <p style="margin: 5px 0;">• Esperando: em filas e trânsito</p>
        </div>
        <div style="text-align: center; margin-top: 20px;">
            <p style="color: #10b981; font-style: italic;">"Transforme cada momento em limpeza"</p>
        </div>`
    },
    {
        title: "😊 Ho'oponopono e Emoções",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🎭 Limpando Estados Emocionais</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Cada emoção carrega informações sobre memórias. Use-as como guia, não resista.</p>
        <div style="background: rgba(139, 92, 246, 0.1); padding: 20px; border-radius: 10px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong>🎭 Emoções como Mestras:</strong></p>
            <p style="color: #ef4444; margin: 3px 0;"><strong>😠 Raiva:</strong> Memórias de injustiça</p>
            <p style="color: #f59e0b; margin: 3px 0;"><strong>😰 Medo:</strong> Memórias de perigo</p>
            <p style="color: #8b5cf6; margin: 3px 0;"><strong>😢 Tristeza:</strong> Memórias de perda</p>
            <p style="color: #ef4444; margin: 3px 0;"><strong>😤 Frustração:</strong> Memórias de impotência</p>
        </div>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 15px; border-radius: 10px; text-align: center;">
            <p style="color: #10b981;">Sinta → Aceite → Ho'oponopono → Deixe ir</p>
        </div>`
    },
    {
        title: "💔 Limpeza de Traumas",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌸 Curando Feridas Profundas</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Para traumas profundos, use abordagem suave. O Ho'oponopono pode curar até feridas ancestrais.</p>
        <div style="background: rgba(139, 92, 246, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #8b5cf6;">🌸 Para Traumas:</strong></p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Sinto muito pela dor que carrego"</p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Me perdoe por manter ferida viva"</p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Te amo, criança ferida em mim"</p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Sou grato pela cura que começou"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em; color: #10b981;">Seja gentil e paciente consigo mesmo 💚</p>`
    },
    {
        title: "💰 Limpeza Financeira",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">💎 Bloqueios de Abundância</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Dificuldades financeiras refletem memórias de escassez e desvalorização.</p>
        <div style="background: rgba(239, 68, 68, 0.2); padding: 15px; border-radius: 10px; margin: 15px 0;">
            <p style="font-size: 1.1em; margin-bottom: 8px;"><strong style="color: #ef4444;">💸 Memórias Limitantes:</strong></p>
            <p style="font-size: 0.9em; margin: 3px 0;">• "Dinheiro é sujo"</p>
            <p style="font-size: 0.9em; margin: 3px 0;">• "Não mereço abundância"</p>
            <p style="font-size: 0.9em; margin: 3px 0;">• "Só ricos ficam ricos"</p>
        </div>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 15px; border-radius: 10px; text-align: center;">
            <p style="color: #10b981; margin: 3px 0;">Ao pagar contas: "Te amo, dinheiro que circula"</p>
            <p style="color: #10b981; margin: 3px 0;">Vendo preços: "Me perdoe por limitar prosperidade"</p>
        </div>`
    },
    {
        title: "💕 Relacionamentos",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">👥 Curando Conexões</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Conflitos relacionais são espelhos de memórias internas. Cure-se e cure a relação.</p>
        <div style="background: rgba(139, 92, 246, 0.2); padding: 15px; border-radius: 10px; margin: 15px 0;">
            <p style="font-size: 1.1em; margin-bottom: 8px;"><strong style="color: #8b5cf6;">💔 Padrões para Limpar:</strong></p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Codependência → Memórias de abandono</p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Ciúme → Memórias de traição</p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Controle → Memórias de insegurança</p>
        </div>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 15px; border-radius: 10px;">
            <p style="color: #10b981; text-align: center;"><strong>💖 Prática:</strong></p>
            <p style="color: #e9d5ff; text-align: center; font-size: 0.95em;">Pessoa irrita = agradeça pelo espelho e limpe</p>
        </div>`
    },
    {
        title: "🌿 Saúde e Cura",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌿 Corpo como Espelho</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Sintomas físicos podem ser manifestações de memórias emocionais não resolvidas.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; text-align: center; margin-bottom: 10px;"><strong>🙏 Oração de Cura:</strong></p>
            <p style="color: #e9d5ff; text-align: center; font-size: 0.95em; margin: 3px 0;">"Sinto muito pelas memórias que criaram</p>
            <p style="color: #e9d5ff; text-align: center; font-size: 0.95em; margin: 3px 0;">este desequilíbrio. Me perdoe."</p>
            <p style="color: #e9d5ff; text-align: center; font-size: 0.95em; margin: 3px 0;">"Te amo. Sou grato pela perfeita</p>
            <p style="color: #e9d5ff; text-align: center; font-size: 0.95em; margin: 3px 0;">saúde que és, Divindade."</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">⚠️ Ho'oponopono complementa, nunca substitui tratamento médico.</p>`
    },
    {
        title: "💼 Ho'oponopono no Trabalho",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">💼 Transformando o Ambiente</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Aplique silenciosamente em reuniões, conflitos e desafios profissionais.</p>
        <div style="background: rgba(139, 92, 246, 0.1); padding: 20px; border-radius: 10px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong>📋 Situações Práticas:</strong></p>
            <p style="margin: 3px 0;"><strong>Chefe irritado:</strong> "Sinto muito pela raiva em mim"</p>
            <p style="margin: 3px 0;"><strong>Colega difícil:</strong> "Me perdoe por julgar"</p>
            <p style="margin: 3px 0;"><strong>Projeto complicado:</strong> "Te amo, solução perfeita"</p>
            <p style="margin: 3px 0;"><strong>Estresse:</strong> "Sou grato pela paz"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">Ninguém precisa saber. A limpeza é silenciosa e transforma tudo! ✨</p>`
    },
    {
        title: "🎨 Criando com a Divindade",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌟 Manifestação Divina</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">No Ho'oponopono, não tentamos manifestar com a mente. Limpamos e deixamos a Divindade criar.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #10b981;">🌟 Processo Divino:</strong></p>
            <p style="margin: 3px 0;">1. Identifique desejo/problema</p>
            <p style="margin: 3px 0;">2. Aplique Ho'oponopono</p>
            <p style="margin: 3px 0;">3. Chegue ao Zero State</p>
            <p style="margin: 3px 0;">4. Siga a inspiração divina</p>
            <p style="margin: 3px 0;">5. Agradeça pela perfeição</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em; text-align: center; color: #10b981; font-style: italic;">"Eu não sei, mas a Divindade sabe"</p>`
    },
    {
        title: "💔 Perdoando o Imperdoável",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">💎 Cura de Feridas Profundas</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Para traumas e mágoas muito profundas, Ho'oponopono oferece um caminho suave.</p>
        <p style="line-height: 1.8; font-size: 1.1em;">Você não precisa perdoar à força. Apenas limpe e deixe o perdão acontecer naturalmente.</p>
        <div style="background: rgba(139, 92, 246, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="color: #e9d5ff; text-align: center; font-size: 0.95em; margin: 5px 0;">"Sinto muito pela dor que carrego"</p>
            <p style="color: #e9d5ff; text-align: center; font-size: 0.95em; margin: 5px 0;">"Me perdoe por manter essa memória viva"</p>
            <p style="color: #e9d5ff; text-align: center; font-size: 0.95em; margin: 5px 0;">"Te amo, criança ferida em mim"</p>
            <p style="color: #e9d5ff; text-align: center; font-size: 0.95em; margin: 5px 0;">"Sou grato pela cura que já começou"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">O perdão verdadeiro é um presente da Divindade, não esforço pessoal.</p>`
    },
    {
        title: "🙏 Gratidão Constante",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌟 O Poder do Obrigado</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Gratidão é a frequência mais alta do Ho'oponopono. Quando agradece, se alinha com abundância divina.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #10b981;">✨ Gratidão Diária:</strong></p>
            <p style="margin: 3px 0;">• Ao despertar: por estar vivo</p>
            <p style="margin: 3px 0;">• Pelos problemas: que fazem crescer</p>
            <p style="margin: 3px 0;">• Pelas pessoas difíceis: que ensinam</p>
            <p style="margin: 3px 0;">• Pela oportunidade: de limpar memórias</p>
        </div>
        <div style="text-align: center; margin-top: 20px;">
            <p style="font-size: 1.2em; color: #10b981;">🌺 MAHALO 🌺</p>
            <p style="color: #a78bfa; font-style: italic;">(Obrigado em havaiano)</p>
        </div>`
    },
    {
        title: "🌅 Rotina Matinal",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌅 Começando o Dia Limpo</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Como você começa o dia determina a qualidade de tudo que vem depois.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #10b981;">☀️ Rotina Sugerida:</strong></p>
            <p style="margin: 5px 0;"><strong>1.</strong> Ao despertar: "Sou grato por este novo dia"</p>
            <p style="margin: 5px 0;"><strong>2.</strong> No banho: Deixe a água levar as memórias</p>
            <p style="margin: 5px 0;"><strong>3.</strong> No café: "Te amo, dia perfeito"</p>
            <p style="margin: 5px 0;"><strong>4.</strong> Antes de sair: "Me perdoe por qualquer erro"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em; text-align: center; color: #10b981; font-style: italic;">Inicie cada dia em Zero State!</p>`
    },
    {
        title: "🌙 Rotina Noturna",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌙 Limpando o Dia</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Antes de dormir, limpe tudo que aconteceu durante o dia para não levar memórias para o sonho.</p>
        <div style="background: rgba(139, 92, 246, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #8b5cf6;">🌙 Limpeza Noturna:</strong></p>
            <p style="margin: 5px 0;"><strong>1.</strong> Revise o dia mentalmente</p>
            <p style="margin: 5px 0;"><strong>2.</strong> Para cada situação difícil: Ho'oponopono</p>
            <p style="margin: 5px 0;"><strong>3.</strong> Agradeça pelas lições</p>
            <p style="margin: 5px 0;"><strong>4.</strong> Durma em paz e gratidão</p>
        </div>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 15px; border-radius: 10px; text-align: center;">
            <p style="color: #10b981;">"Sinto muito, me perdoe, te amo, sou grato por tudo hoje"</p>
        </div>`
    },
    {
        title: "🚗 Ho'oponopono no Trânsito",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🚗 Transformando o Estresse</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Trânsito é uma oportunidade perfeita para limpeza. Transforme irritação em paz.</p>
        <div style="background: rgba(239, 68, 68, 0.2); padding: 15px; border-radius: 10px; margin: 15px 0;">
            <p style="font-size: 1.1em; margin-bottom: 8px;"><strong style="color: #ef4444;">🚨 Situações Comuns:</strong></p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Trânsito parado</p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Motorista imprudente</p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Atraso para compromisso</p>
        </div>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 15px; border-radius: 10px;">
            <p style="color: #10b981; text-align: center; margin: 3px 0;">Parado: "Sou grato por este tempo para limpar"</p>
            <p style="color: #10b981; text-align: center; margin: 3px 0;">Irritado: "Me perdoe pela impaciência em mim"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">Chegue aos destinos em paz! 🕊️</p>`
    },
    {
        title: "🍽️ Limpeza Durante Refeições",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🍽️ Alimentando Corpo e Alma</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Refeições são momentos sagrados. Limpe a comida e a si mesmo enquanto se alimenta.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #10b981;">🍽️ Prática Alimentar:</strong></p>
            <p style="margin: 5px 0;"><strong>Antes:</strong> "Te amo, alimento sagrado"</p>
            <p style="margin: 5px 0;"><strong>Durante:</strong> Coma conscientemente</p>
            <p style="margin: 5px 0;"><strong>Mastigando:</strong> "Sou grato pela nutrição"</p>
            <p style="margin: 5px 0;"><strong>Depois:</strong> "Me perdoe por qualquer desperdício"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">A comida absorve suas intenções e vibração! Abençoe tudo que entra no seu corpo. 🙏</p>`
    },
    {
        title: "💻 Ho'oponopono Digital",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">💻 Limpando o Mundo Virtual</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Redes sociais e tecnologia também podem ser campos de limpeza e transformação.</p>
        <div style="background: rgba(139, 92, 246, 0.2); padding: 15px; border-radius: 10px; margin: 15px 0;">
            <p style="font-size: 1.1em; margin-bottom: 8px;"><strong style="color: #8b5cf6;">📱 Momentos Digitais:</strong></p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Post irritante: "Sinto muito pelo julgamento"</p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Notícia ruim: "Me perdoe por atrair isso"</p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Tecnologia lenta: "Te amo, paciência"</p>
        </div>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 15px; border-radius: 10px; text-align: center;">
            <p style="color: #10b981;">Antes de postar: "Que isso traga paz ao mundo"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">Seja um farol de luz no mundo digital! ✨</p>`
    },
    {
        title: "🏠 Limpeza do Ambiente",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🏠 Purificando Espaços</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Ambientes absorvem energia. Use Ho'oponopono para limpar casas, escritórios e qualquer lugar.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #10b981;">🏡 Limpeza Espacial:</strong></p>
            <p style="margin: 5px 0;"><strong>Entrando:</strong> "Sou grato por este espaço sagrado"</p>
            <p style="margin: 5px 0;"><strong>Limpando:</strong> "Te amo, harmonia perfeita"</p>
            <p style="margin: 5px 0;"><strong>Organizando:</strong> "Me perdoe por qualquer bagunça"</p>
            <p style="margin: 5px 0;"><strong>Saindo:</strong> "Sinto muito, que a paz permaneça"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">Sua casa reflete seu estado interno. Limpe dentro, limpe fora! 🏡</p>`
    },
    {
        title: "🌍 Ho'oponopono Global",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🌍 Curando o Planeta</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Você pode usar Ho'oponopono para situações mundiais: guerras, pandemias, crises ambientais.</p>
        <div style="background: rgba(139, 92, 246, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #8b5cf6;">🌍 Para o Mundo:</strong></p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Sinto muito pelas memórias de guerra"</p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Me perdoe por contribuir com o ódio"</p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Te amo, Terra sagrada"</p>
            <p style="color: #e9d5ff; font-size: 0.95em; margin: 3px 0;">"Sou grato pela paz mundial"</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em; text-align: center; color: #10b981; font-style: italic;">Cada pessoa que se cura, cura o mundo inteiro! 🌏</p>`
    },
    {
        title: "👶 Ho'oponopono com Crianças",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">👶 Pequenos Mestres</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Crianças são naturalmente próximas ao Zero State. Elas podem ensinar muito sobre amor incondicional.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 15px; border-radius: 10px; margin: 15px 0;">
            <p style="font-size: 1.1em; margin-bottom: 8px;"><strong style="color: #10b981;">👶 Com Crianças Difíceis:</strong></p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Birra: "Sinto muito pela frustração em mim"</p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Desobediência: "Me perdoe por criar resistência"</p>
            <p style="font-size: 0.9em; margin: 3px 0;">• Agressividade: "Te amo, paz interior"</p>
        </div>
        <div style="background: rgba(139, 92, 246, 0.2); padding: 15px; border-radius: 10px; text-align: center;">
            <p style="color: #8b5cf6;">Ensine pelo exemplo: crianças sentem sua vibração</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">Elas nos mostram o que precisa ser curado! 🌟</p>`
    },
    {
        title: "🌟 Sinais de Progresso",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">✨ Como Saber que Está Funcionando</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Ho'oponopono funciona mesmo quando não vemos resultados imediatos. Aprenda a reconhecer os sinais.</p>
        <div style="background: rgba(16, 185, 129, 0.2); padding: 20px; border-radius: 15px; margin: 20px 0;">
            <p style="font-size: 1.1em; margin-bottom: 10px;"><strong style="color: #10b981;">🌟 Sinais de Limpeza:</strong></p>
            <p style="margin: 3px 0;">• Mais paz nas situações difíceis</p>
            <p style="margin: 3px 0;">• Sincronicidades aumentando</p>
            <p style="margin: 3px 0;">• Pessoas reagindo melhor a você</p>
            <p style="margin: 3px 0;">• Soluções aparecendo naturalmente</p>
            <p style="margin: 3px 0;">• Menos reatividade emocional</p>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em;">Confie no processo, mesmo sem ver resultados externos imediatos! 🙏</p>`
    },
    {
        title: "🎓 Sua Jornada Continua",
        content: `<h3 style="color: #a78bfa; margin-bottom: 15px;">🚀 Próximos Passos</h3>
        <p style="line-height: 1.8; font-size: 1.1em;">Parabéns! Você completou o Módulo 2 e agora entende profundamente a ciência da responsabilidade total.</p>
        <div style="background: linear-gradient(135deg, rgba(139, 92, 246, 0.3), rgba(16, 185, 129, 0.3)); padding: 25px; border-radius: 20px; text-align: center; margin: 25px 0;">
            <p style="font-size: 1.2em; color: #ffffff; margin-bottom: 15px;">🏆 MÓDULO 2 COMPLETO 🏆</p>
            <p style="font-size: 1.1em; color: #e9d5ff; margin-bottom: 15px;">Você agora é um praticante avançado</p>
            <div style="margin: 15px 0;">
                <p style="font-size: 1.1em; margin: 5px 0; color: #ffffff;">Sinto muito</p>
                <p style="font-size: 1.1em; margin: 5px 0; color: #ffffff;">Me perdoe</p>
                <p style="font-size: 1.1em; margin: 5px 0; color: #ffffff;">Te amo</p>
                <p style="font-size: 1.1em; margin: 5px 0; color: #ffffff;">Sou grato</p>
            </div>
        </div>
        <p style="line-height: 1.8; font-size: 1.1em; text-align: center; color: #10b981;">Continue praticando! O Módulo 3 te espera! 🌺</p>`
    }
];
        },
        3: {
