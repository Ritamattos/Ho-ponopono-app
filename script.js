// ===== HO'OPONOPONO APP - SCRIPT COMPLETO COM ADMIN FUNCIONAL =====
...
function abrirModulo(num) {
    ...
    if (isMobile) {
        // No mobile: criar uma página por spread
...
window.comentar = comentar;// ===== HO'OPONOPONO APP - SCRIPT COMPLETO COM ADMIN FUNCIONAL =====
